...
public class TestScripts extends BaseTest
{
	...
	public void AccountCreation() throws InterruptedException
	{
		...
		homep.setEmail("TestRekha1234@gmail.com");
		homep.CreateActClick();		
		PageVerification.VerifyTitle("Login - My Store");
		Actp.MrsClick();
		Actp.setfName("TestRekha");
		Actp.setlName("Tharma");
		Actp.chkEmail();
		Actp.setpwd("Test1234561");
	...
	public void SignIn() 
	{
		...
		homep.SignInClick();
		PageVerification.VerifyTitle("Login - My Store");
		homep.setEmailSignIn("TestRekha1234@gmail.com");
		homep.setPwd("Test1234561");
		homep.SubmitClick();
